export const Building = ({ content, className = "w-12 h-12", style, fontSize }) => {
    return (
        <div className="relative w-fit" style={style}>
            ...
            <p className={`absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-35%] z-10 font-serif font-bold ${fontSize}`}>{content}</p>
        </div>
    )
}
