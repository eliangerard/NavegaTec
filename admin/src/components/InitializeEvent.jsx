        ...
        <>
            ...
            <div className="grid grid-cols-2 gap-4 w-full h-2/3 mt-12">
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col justify-center text-center rounded-lg border-[3px] border-black nt-shadow-sm p-4 grow mt-2">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-2 grow mt-2">
                        <button onClick={() => handleType('administrative')} className="border-[3px] border-black nt-shadow-sm h-full w-full rounded-lg bg-purple">DIRECCIÓN</button>
                        <button onClick={() => handleType('papers')} className="border-[3px] border-black nt-shadow-sm h-full w-full rounded-lg bg-green">TRÁMITES</button>
                        <button onClick={() => handleType('security')} className="border-[3px] border-black nt-shadow-sm h-full w-full rounded-lg bg-red">SEGURIDAD</button>
                        <button onClick={() => handleType('warning')} className="border-[3px] border-black nt-shadow-sm h-full w-full rounded-lg bg-yellow">AVISOS</button>
                    </div>
                </div>
            </div>
        </>
